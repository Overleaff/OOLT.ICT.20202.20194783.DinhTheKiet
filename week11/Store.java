...
public Store initalStore(){
    ...
    DigitalVideoDisc dvd1 = 
        new DigitalVideoDisc(4, "The Lion King1Store", "Animation1", 84);
    Store1.addMediaStore(dvd1);

    DigitalVideoDisc dvd2 = 
        new DigitalVideoDisc(5, "The Lion King2Store", "Animation1", 85);
    Store1.addMediaStore(dvd2);

    DigitalVideoDisc dvd3 = 
        new DigitalVideoDisc(6, "The Lion King3Store", "Animation1", 86);
